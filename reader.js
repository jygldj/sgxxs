        ...
        function parseHashId() {
            ...
            return (id >= 1 && id <= articles.length) ? id : null;
        }
        ...
        window.addEventListener('hashchange', function() {
            if (isDataLoaded) openArticleFromHash();
        });
        ...
        function renderArticleList() {
            ...
            if (filteredArticles.length > 0) {
                ...
                const li = document.createElement('li');
                li.innerHTML = `<div class="empty-hint">没有找到符合条件的文章</div>`;
                fragment.appendChild(li);
            }
        ...
        function loadArticle(index) {
            ...
            setTimeout(() => {
                ...
                let content = DXRender.renderBody(article.body, article.category);
                ...
                // 更新地址栏 hash，使当前文章拥有可分享的独立网址
                if (location.hash !== '#' + article.id) {
        ...
        function searchArticles() {
            ...
            const filtered = articles.filter(a =>
                ...
                (a.juan && a.juan.toLowerCase().includes(currentSearchKeyword))
            );
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            DXTheme.initTools({
                share: function() {
                    ...
                    return base + '#' + (currentArticleIndex + 1);
                }
            });

            // 离线缓存（Service Worker）：成功打开一次后，网络卡顿/断网也能阅读
            if ('serviceWorker' in navigator && location.protocol !== 'file:') {
                navigator.serviceWorker.register('sw.js').catch(function(){});
                let updateToastTimer = null;
                navigator.serviceWorker.addEventListener('message', function(e) {
                    if (e.data && e.data.type === 'dx-update-available') {
                        clearTimeout(updateToastTimer);
                        updateToastTimer = setTimeout(function() {
                            DXTheme.toast('📄 网站内容有更新，刷新页面即可查看最新文章');
                        }, 1500);
                    }
                });
            }
